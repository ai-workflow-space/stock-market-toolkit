...
class NotificationSettings(Base):
    ...
    smtp_host = Column(String(length=255), nullable=True)
    smtp_port = Column(Integer, nullable=True, default=587)
    smtp_use_tls = Column(Boolean, nullable=True, default=True)
    smtp_username = Column(String(length=255), nullable=True)
    smtp_password_encrypted = Column(Text, nullable=True)
    smtp_from_address = Column(String(length=255), nullable=True)
    smtp_reply_to = Column(String(length=255), nullable=True)
    updated_at = Column(
